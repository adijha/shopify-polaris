	...
	return (
		<Fragment>
			...
			>
				<div>
					<Layout>
						...
						>
							<Card sectioned>
								<div style={{ padding: '3rem' }}>
									<DefaultTextField name="admin-no" label="Admin Phone No." type="text" maxLength="10" />
								</div>
							</Card>
						</Layout.AnnotatedSection>
						<Layout.AnnotatedSection
						...
						>
							<Card sectioned>
								<div style={{ padding: '3rem' }}>
									<DefaultTextField name="sender-id" label="Sender ID" type="text" maxLength="6" />
								</div>
							</Card>
						</Layout.AnnotatedSection>
						<Layout.AnnotatedSection
				...
				<br />
				<div style={{ textAlign: 'right' }} onClick={myFunction}>
